...
const NavBar = () => {
    ...
    const womenCategories = categories.filter(
        (category) =>
            getCategoryGender(category) === "kadin"
    );

    const menCategories = categories.filter(
        (category) =>
            getCategoryGender(category) === "erkek"
    );
                        ...
                        >
                            ...
                            {cart.length > 0 && (
                                <div className="flex gap-3 border-t border-[#E8E8E8] p-4">
                                    ...
                                    <Link
                                        to="/cart"
                                        className="flex-1 rounded border border-[#BDBDBD] bg-white py-3 text-center text-sm font-bold !text-[#252B42] !no-underline transition hover:bg-[#FAFAFA]"
                                    >
                                        Sepete Git
                                    </Link>
                                    ...
                                    <Link
                                        to="/create-order"
                                        className="flex-1 rounded bg-[#E77C40] py-3 text-center text-sm font-bold !text-white !no-underline transition hover:bg-[#d86d32]"
                                    >
                                        Siparişi Tamamla
                                    </Link>
